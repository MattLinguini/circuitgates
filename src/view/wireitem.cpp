...
#include "qpen.h"
#include "src/view/gateslotitem.h"
#include <cmath>

static constexpr float SCALE = 30.0f;

WireItem::WireItem(b2World* world, GateSlotItem* startSlot, GateSlotItem* endSlot, int segmentCount) : world(world), startSlot(startSlot), endSlot(endSlot) {
