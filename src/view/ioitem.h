...
class IOItem : public GameItem {
    public:
        ...
        IOItem(b2World* world, float centerX, float centerY, float width, float height, float padding, float cellSize, int id, bool state, bool isOutput, bool expectedtState, QGraphicsItem* parent = nullptr);
